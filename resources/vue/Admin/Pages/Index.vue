<template>
    <PageLayout :pageTitle=" $t('admin.main.edarah')" >
 <h4 class="page-title">{{$t('admin.main.edarah')}}</h4>
            ...
            <div class="row">
                    ...
                    <div class="card p-2 mt-1">
                        <div class="information">
                            <div class="information-content">
                                <div class="information-title">{{ $t('admin.main.new-users') }}</div>
                ...
                <div class="col-sm">
                    <div class="card p-2 mt-1">
                        <div class="information">
                            <div class="information-content">
                                <div class="information-title">{{ $t('admin.main.new-orders') }} </div>
                ...
                <div class="col-sm">
                    <div class="card p-2 mt-1">
                        <div class="information">
                            <div class="information-content">
                                <div class="information-title t">{{ $t('admin.main.this-month-earnings') }}</div>
        ...
        <section>
            <div class="row">
              ...
              datasets-spacing-9">
                            <caption class="title"> {{ $t('admin.main.sales') }} </caption>
                            <thead>
                            <tr>
              ...
              show-data-on-hover show-labels show-primary-axis">
                            <caption class="title"> {{ $t('admin.main.orders') }} </caption>
